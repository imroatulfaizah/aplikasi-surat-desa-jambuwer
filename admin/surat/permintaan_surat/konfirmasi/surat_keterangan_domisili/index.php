      ...
      <div class="col-md-12">
        <div class="box box-default">
          <div class="box-header with-border">
            <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Surat Keterangan Domisili</h2>
            ...
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                  <?php 
                    $surat = mysqli_query($connect, "SELECT * FROM nomor_surat WHERE jenis_surat = 'surat_keterangan_domisili'");
                    $surat_fetch = mysqli_fetch_array($surat);
                    $jumlah = mysqli_query($connect, "SELECT * FROM surat_keterangan_domisili");
