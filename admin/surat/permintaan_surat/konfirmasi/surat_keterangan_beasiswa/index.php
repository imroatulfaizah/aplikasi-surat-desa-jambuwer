<?php 
  ...
  $id = $_GET['id'];
  $qCek = mysqli_query($connect,"SELECT penduduk.*, surat_keterangan_beasiswa.* FROM penduduk LEFT JOIN surat_keterangan_beasiswa ON surat_keterangan_beasiswa.nik = penduduk.nik WHERE surat_keterangan_beasiswa.id_sk='$id'");
            ...
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                  <?php 
                    $surat = mysqli_query($connect, "SELECT * FROM nomor_surat WHERE jenis_surat = 'surat_keterangan_beasiswa'");
                    $surat_fetch = mysqli_fetch_array($surat);
                    $jumlah = mysqli_query($connect, "SELECT * FROM surat_keterangan_beasiswa WHERE jenis_surat = 'Surat Keterangan Status'");
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fnama_anak" style="text-transform: capitalize;" value="<?php echo $row['nama_anak']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fnama_anak" style="text-transform: capitalize;" value="<?php echo $row['tempat_lahir']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fnama_anak" style="text-transform: capitalize;" value="<?php echo $row['tanggal_lahir']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Jenis Kelamin</label>
                      <div class="col-sm-9">
                        <input type="text" name="fnama_anak" style="text-transform: capitalize;" value="<?php echo $row['jenis_kelamin']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fnama_anak" style="text-transform: capitalize;" value="<?php echo $row['nama_sekolah']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fnama_anak" style="text-transform: capitalize;" value="<?php echo $row['kelas']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
