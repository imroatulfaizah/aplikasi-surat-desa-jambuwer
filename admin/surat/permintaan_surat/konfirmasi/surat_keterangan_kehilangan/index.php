            ...
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                  <?php 
                    $surat = mysqli_query($connect, "SELECT * FROM nomor_surat WHERE jenis_surat = 'surat_keterangan'");
                    $surat_fetch = mysqli_fetch_array($surat);
                    $jumlah = mysqli_query($connect, "SELECT * FROM surat_keterangan WHERE jenis_surat = 'Surat Keterangan Kehilangan' && status_surat = 'SELESAI'");
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Barang yang Hilang</label>
                      <div class="col-sm-9">
                        <input type="text" name="fkeperluan" style="text-transform: capitalize;" value="<?php echo $row['keperluan']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Tanggal Hilang</label>
                      <div class="col-sm-9">
                        <input type="text" name="ftgl_hilang" style="text-transform: capitalize;" value="<?php echo $row['tgl_hilang']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
