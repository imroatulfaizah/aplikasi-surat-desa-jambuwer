              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <?php 
                    ...
                    $jumlah = mysqli_query($connect, "SELECT * FROM surat_keterangan WHERE jenis_surat = 'Surat Keterangan Penghasilan Orang Tua' && status_surat = 'SELESAI'");
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fpenghasilan" style="text-transform: capitalize;" value="<?php echo $row['penghasilan']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
