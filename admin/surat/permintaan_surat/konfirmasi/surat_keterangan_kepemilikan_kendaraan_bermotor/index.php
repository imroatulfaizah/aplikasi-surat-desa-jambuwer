            ...
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                  <?php 
                    $surat = mysqli_query($connect, "SELECT * FROM nomor_surat WHERE jenis_surat = 'surat_keterangan_kepemilikan_kendaraan_bermotor'");
                    $surat_fetch = mysqli_fetch_array($surat);
                    $jumlah = mysqli_query($connect, "SELECT * FROM surat_keterangan_kepemilikan_kendaraan_bermotor");
