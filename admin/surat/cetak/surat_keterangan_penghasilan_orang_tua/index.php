...
<div>
	...
	<div id="isi3">
		...
		<table width="100%">
			<tr>
				<td class="indentasi">1. Orang tersebut diatas benar-benar penduduk kami Dusun <a style="text-transform: capitalize;"><?php echo $row['dusun']; ?>, Desa <?php echo $rows['nama_desa']; ?>, Kecamatan <?php echo $rows['kecamatan']; ?>, <?php echo $rows['kota']; ?>, Provinsi <?php echo $rows['provinsi']; ?></a></td>
			</tr>
            <tr>
            <br><td class="indentasi">2. 2.	Orang tersebut telah benar-benar diteliti bahwa hingga saat ini yang bersangkutan benar-benar sebagai orang tua dari <a style="text-transform: capitalize;"><u><b><?php echo $row['keperluan']; ?>.</a></u></b> yang berpenghasilan tetap Rp <a style="text-transform: capitalize;"><u><b><?php echo $row['penghasilan']; ?>.</a></u></b> perbulan. </td>
            </tr>
		</table><br>
		<!-- <table width="100%">
			<tr>
		...
		<table width="100%">
			<tr>
				<td class="indentasi">Demikian surat keterangan ini kami buat dengan sebenarnya dan dapat dipergunakan sebagaimana mestinya.</td>
			</tr>
		</table>
	</div>
	<br>
