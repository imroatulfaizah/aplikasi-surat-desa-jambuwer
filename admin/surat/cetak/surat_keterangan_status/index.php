...
<div>
	...
	<div id="isi3">
		...
		<table width="100%">
            ...
            <tr>
            <br><td class="indentasi">2. Orang tersebut telah benar-benar diteliti bahwa hingga saat ini yang bersangkutan tersebut diatas benar-benar berstatus <a style="text-transform: capitalize;"><u><b><?php echo $row['keperluan']; ?>.</a></u></b></td>
            </tr>
		</table><br>
		<!-- <table width="100%">
			<tr>
