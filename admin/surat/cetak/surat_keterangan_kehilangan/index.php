...
<div>
	<table width="100%">
		...
		<br>
		<div align="center"><u><h4 class="kop">SURAT PERNYATAAN KEHILANGAN</h4></u></div>
	...
	<div id="isi3">
		...
		<table width="100%">
			<tr>
				<td class="indentasi">Bahwa saya tersebut diatas benar-benar penduduk Desa Jambuwer Kecamatan Kromengan Kabupaten Malang, yang mana saya telah kehilangan <a style="text-transform: capitalize;"><u><b><?php echo $row['keperluan']; ?>.</a></u></b> pada tanggal <a style="text-transform: capitalize;"><u><b><?php echo $row['tgl_hilang']; ?></a></u></b>.</td>
			</tr>
		</table><br>
		<!-- <table width="100%">
			<tr>
		...
		<table width="100%">
			<tr>
				<td class="indentasi">Demikian surat pernyataan ini saya buat dibuat dengan sebenarnya dan dapat dipergunakan sebagaimana mestinya.</td>
			</tr>
		</table>
	</div>
	<br>
