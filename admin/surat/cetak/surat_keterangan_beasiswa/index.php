  	...
  	while($row = mysqli_fetch_array($qCek)){
        ...
        foreach($qTampilDesa as $rows){
			...
			$id_pejabat_desa = $row['id_pejabat_desa'];
		  	$qCekPejabatDesa = mysqli_query($connect,"SELECT pejabat_desa.jabatan, pejabat_desa.nama_pejabat_desa FROM pejabat_desa LEFT JOIN surat_keterangan_beasiswa ON surat_keterangan_beasiswa.id_pejabat_desa = pejabat_desa.id_pejabat_desa WHERE surat_keterangan_beasiswa.id_pejabat_desa = '$id_pejabat_desa' AND surat_keterangan_beasiswa.id_sk='$id'");
...
<div>
	...
	<div id="isi3">
		...
		<table width="100%">
			<tr>
				<td class="indentasi">Orang tersebut diatas benar-benar penduduk Desa Jambuwer mempunyai seorang anak yang akan sekolah di <a style="text-transform: capitalize;"><u><b><?php echo $row['nama_sekolah']; ?></a></u></b>, dan orang tua tersebut diatas kurang mampu untuk membiayai pendidikan anak tersebut, maka dengan ini mengharapkan dengan hormat kepada Kepala Sekolah untuk dapat memberikan keringanan biaya sekolah kepada anak orang tersebut diatas, dengan data anak sebagai berikut : </td>
			</tr>
        </table>
        <table width="100%" style="text-transform: capitalize;">
            <tr>
		...
		<table width="100%">
			<tr>
				<td class="indentasi">Demikian surat keterangan ini kami buat dengan sebenarnya dan untuk dapat dipergunakan sebagaimana mestinya. Atas perhatian dan bantuanya kami ucapkan terima kasih.</td>
			</tr>
		</table>
	</div>
	<br>
