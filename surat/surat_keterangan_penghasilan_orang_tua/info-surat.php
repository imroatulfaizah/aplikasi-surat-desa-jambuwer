				...
				<div class="card">
					...
					<form method="post" action="simpan-surat.php">
						...
						<div class="row">
						  	<div class="col-sm-12">
						      	<div class="form-group">
						           	...
						           	<div class="col-sm-12">
						               	<input type="text" name="fkeperluan" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan Nama Anak" required>
						           	</div>
						        </div>
						  	</div>
						</div>
                        <div class="row">
						  	<div class="col-sm-12">
						      	<div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Jumlah Penghasilan</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="fpenghasilan" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan Penghasilan Perbulan" required>
						           	</div>
						        </div>
						  	</div>
						</div>
