	  	...
	  	<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
	    	<ul class="navbar-nav ml-auto mt-lg-3 mr-5 position-relative text-right">
	      		...
	      		<!-- <li class="nav-item active">
	        		<a class="nav-link" href="#"><i class="fas fa-info-circle"></i>&nbsp;TENTANG <b>E-MailService</b></a>
	      		</li> -->
	...
	<div class="container shadow p-3 mb-5 mt-lg-5 bg-white rounded">
		<div style="max-height:cover; padding-top:30px; padding-bottom:60px; position:relative; min-height: 100%;">
			<div class="card-body">
				<div class="card-text">
					<p>
						<label style="font-weight: 700;font-size: 25px"><i class="fas fa-info-circle"></i> APA ITU E-MailService?</label>
						<hr>
						<blockquote>
							Web Aplikasi untuk pelayanan surat administrasi desa yang dikembangkan oleh <b><a href="#" style="text-decoration:none">E-MailService</a></b> untuk mempermudah penduduk dalam pembuatan surat administrasi desa secara online.
							<br>
							<br>
						</blockquote>
					</p>
					...
					<hr>
					<b>©</b> E-<b>MailService</b> 2021. Hak Cipta Dilindungi.
				</div>
				<br><br><br>
				<div class="row text-center">
					<div class="col-md-12">
						<!-- <img src="../assets/img/adi.jpg" class="img-circle"><br><br> -->
						<p class="text-muted">Trademark By <b><a href="#" style="text-decoration:none">Desa JAMBUWER.</a></b></p>
					</div>
